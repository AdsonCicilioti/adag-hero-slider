...
/* harmony import */ var _edit_edit_settings_control__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit/edit__settings-control */ "./src/edit/edit__settings-control.js");
...
function Edit(_ref) {
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)(); // REF AND EFFECT to stylize base layout on editor

  const sliderRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createRef)();
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const sliderList = sliderRef.current;
    const slideItems = sliderRef.current.querySelectorAll("div > div.block-editor-block-list__block");
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_edit_edit_settings_control__WEBPACK_IMPORTED_MODULE_3__.SliderSettingsControl, {
    ...
    placeholder: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
      style: {
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Add your first slide block", "hero-slider"))
  }));
}

/***/ }),

/***/ "./src/edit/edit__settings-control.js":
/*!********************************************!*\
  !*** ./src/edit/edit__settings-control.js ***!
  \********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SliderSettingsControl": function() { return /* binding */ SliderSettingsControl; }
/* harmony export */ });
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n");
...
const SliderSettingsControl = _ref => {
  let {
    attributes,
    setAttributes
  } = _ref;
